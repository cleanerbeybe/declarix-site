...
1. Hero promises an immediate, private scenario with no sign-up.
2. Official checkpoints help the visitor bring defensible inputs.
3. The workpaper produces the useful number before asking for contact.
4. The result links into desk economics and document-pack workflow tools.
5. The 20-minute numbers call asks for a representative flow and desk numbers, connecting the
   calculation to the product's actual value.

The hero and results use outcome language. Technical boundaries are local and concise. No global
offer or homepage copy is rewritten by this release.
